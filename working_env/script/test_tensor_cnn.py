...
# Convolution, Relu, Pooling first layer
h_conv1 = tf.nn.relu(conv2d(x_image, W_conv1) + b_conv1)
h_pool1 = max_pool_2x2(h_conv1)

# Weight and Bias for second layer
W_conv2 = weight_variables([5, 5, 32, 64])
b_conv2 = bias_variable([64])

# Conv and Pool for the second layer
h_conv2 = tf.nn.relu(conv2d(h_pool1, W_conv2) + b_conv2)
h_pool2 = max_pool_2x2(h_conv2)

# Weight and Bias for full connected NN
W_fc1 = weight_variables([7*7*64, 1024])
b_fc1 = bias_variable([1024])

# Flat h_pool2 and apply relu
